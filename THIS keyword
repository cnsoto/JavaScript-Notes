...
In regular functions every new function defined has its own **THIS** keyword value, which owner is the global object (window)
----
JS Code
...
----
Arrow functions on the other hand don't have their own **THIS** keyword.
...
Functions in JavaScript are a special type of Object and as all Objects it has methods: **call**, **apply** and **bind**. These functions set the
...
----
/*Bind function*/
In this method the first parameter is for defining the reference to **THIS**, all other arguments are pass individually.
----
JS Code
